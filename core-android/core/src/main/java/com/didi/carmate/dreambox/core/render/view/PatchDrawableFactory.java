 ...
 * date: 2020/6/29
 */
class PatchDrawableFactory {
    private static final int NO_COLOR = 0x00000001;

    static NinePatchDrawable createNinePatchDrawable(Resources res, Bitmap bitmap) {
    ...
    static DBRepeatPatchDrawable createRepeatPatchDrawable(Resources res, Bitmap bitmap) {
        RangeLists rangeLists = getPatchRange(bitmap);
        Bitmap trimmedBitmap = trimBitmap(bitmap);
        return new DBRepeatPatchDrawable(trimmedBitmap, rangeLists);
    }

    private static RangeLists getPatchRange(Bitmap bitmap) {
